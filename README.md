...
- FTL-style forward map choices with future route columns, where shops and events are rarer special nodes.
...
- Medic allies spend their turn healing the weakest ally instead of attacking.
- Party members can be dragged in the team panel to reorder battle order.
